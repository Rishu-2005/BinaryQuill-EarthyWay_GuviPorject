...
<body>
	<div class="navbar">
		...
		<nav>
			<input type="checkbox" id="click"> <label for="click"
				class="menubtn"> <i class="fas fa-bars"></i>
			</label>
			<ul class="nav">
	...
	<section>
		<div class="signin">
			<h1>Welcome Back!</h1>
			<h3>Share or borrow vehicles with ease and contribute to a
				greener future</h3>
			<button class="button" id="sigingoogle">
			...
			<button class="button" id="signinapple">
			...
			<p>
				New here? <a id="creatacc" href="register.jsp">Create account</a>
